...
; (function ($, window, document, undefined) {
    ...
    function Plugin(options) {
        ...
        this.layerID = "#" + this.options.idLayer;
    ...
    Plugin.prototype = {
        ...
        init: function () {
            ...
            this.options.targetId = this.hashControl(this.options);
        ...
        bindEvents: function (el, options) {
            ...
            function fnStart(event, elemCurrent) {
                ...
                if (options.mode === "layer") {
                    ...
                    if (!$(elemCurrent).data("alreadyOpen") && orginEvt === options.eventStart) {
        ...
        */
        hashControl: function (opts) {
            return (opts.target.indexOf("#") === -1) ? "#" + opts.target : opts.target;
        }
    };
...
//# sourceMappingURL=jquery.popinGen.js.map